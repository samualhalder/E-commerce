...
import { selectLogedInUser, updateUsersAsync } from "../features/auth/authSlice";
import { addToOrderAsync } from "../features/order/orderSlice";
...
function Checkout() {
  ...
  const handleOrder=(e)=>{
    const order={products,totalPrice,user,selectedAddres,paymentMethode};
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          ...
          dispatch(updateUsersAsync({...user,addresses:[...user.addresses,data]}));
          reset();
          })}
         >
                ...
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                      <input
                        type="text"
                       {...register("name",{requied: "Name is required"})}
                        id="name"
                  ...
                  <div className="sm:col-span-4">
                    ...
                    <div className="mt-2">
                      <input
                        id="email"
                        {...register("email",{requied: "Email is required"})}
                        type="email"
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-2">
                      <input
                        id="phone"
                        {...register("phone",{requied: "Phone is required"})}
                        type="tel"
                  ...
                  <div className="col-span-full">
                    ...
                    <div className="mt-2">
                      <input
                        type="text"
                        {...register("street",{requied: "street is required"})}
                        id="street-address"
                  ...
                  <div className="sm:col-span-2 sm:col-start-1">
                    ...
                    <div className="mt-2">
                      <input
                        type="text"
                        {...register("city",{requied: "city is required"})}
                        id="city"
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2">
                      <input
                        type="text"
                        {...register("region",{requied: "Region is required"})}
                        id="region"
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2">
                      <input
                        type="text"
                        {...register("pinCode",{requied: "PIN code is required"})}
                        id="pinCode"
