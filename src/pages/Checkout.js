...
function Checkout() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-3">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 mb-4">
        <div className="lg:col-span-3">
          <form className="bg-white px-5 px-10 mt-12 py-4">
            <div className="space-y-12">
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <p className="mt-1 text-sm leading-6 text-gray-600">
                  Chose from exitsing address
                  <ul role="list" className="divide-y divide-gray-100">
                    {addres.map((addres) => (
                      <li
                        key={addres.email}
                        className="flex justify-between gap-x-6 py-5 border-solid border-2 border-grey-200 mx-3 my-3 px-2 "
                      >
